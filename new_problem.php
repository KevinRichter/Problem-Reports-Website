...
<?php 
	...
	if ($_SESSION['user_group'] != 'student' && $_SESSION['user_group'] != "faculty") header("Location:internal_problem.php");
?> 
				...
				<div class="wrapper"><strong><span class="auto-style1">Problem 
					...
					<div style="clear:both;"><br />
						...
						<form action="save_report.php" method="post" name="problemReportForm">
							...
							(Please enter full description of the problem here)<br />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							*Problem Type:&nbsp;&nbsp;&nbsp;
							...
							&nbsp;Room:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select name="Building" style="width: 50px">
