			...
			<div id="main_content" class="fancy_border bordered_sidebars grid_13 omega">
				<div class="wrapper"><strong><span class="auto-style1">Problem 
					...
					<div style="clear:both;"><br />
						<br />
						<span class="auto-style2">Create New User Account<br />
						</span><font color="red"><?php echo $_SESSION['emptyError']; echo "\n\n";?></font> <br />
						<br />
						<form action="add_user.php" method="post" name="newUserForm">
							<span class="auto-style3"><br />							
							
							First Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="fname" style="width: 200px" type="text" value="<?php echo $_SESSION['fname']; ?>"/><br />
							<br />
							...
							<input name="email_adr" style="width: 200px" type="text" value="<?php echo $_SESSION['email_adr']; ?>"/><br />
							<br />
							Contact #&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="contact" style="width: 200px" type="text" value="<?php echo $_SESSION['contact']; ?>"/><br />
							<br />
							Username&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="username" style="width: 200px" type="text" 
							value="<?php echo $_SESSION['username']; ?>"/>&nbsp;&nbsp;<span><font color="red"> <?php echo $_SESSION['usernameError']; ?></font><br />
							<br />
							Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<input name="Button1" type="button" value="Reset" onclick="resetForm($('form[name=newUserForm]'))/>
							<br />
							<br />
						</form>
					</div>
