			...
			<div id="main_content" class="fancy_border bordered_sidebars grid_13 omega">
				<div class="wrapper"><strong><span class="auto-style1">Problem 
					...
					<div style="clear:both;"><br />
						...
						<form action="update_report.php?ID=$report_id" method="post" name="problemReportForm">					
							...
							Subject:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="Subject" type="text" value ="<?php echo mysql_result($result, 0, 1); ?>" style="width: 200px" /> (Briefly 
							identify problem)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<span class="auto-style4"></span><br />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<font color="red"><?php echo $_SESSION['missingInfo2']; ?></font><br />
							Description:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 							
							<textarea name="Description" style="width: 400px; height: 81px;"><?php echo mysql_result($result, 0, 2); ?></textarea> 
							<br />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<option value ="<?php echo mysql_result($result, 0, 3); ?>" selected="selected"><?php echo mysql_result($result, 0, 3); ?></option>							
							...
							</select>&nbsp;&nbsp;&nbsp; <input type='text' name='Category'  id='Category' style="display:none" />
							</span>
							<br />
							<br />
							<?php 
							...
							<option value ="<?php echo mysql_result($result, 0, 24); ?>" selected="selected"><?php echo mysql_result($result, 0, 24); ?></option>
							<option>Jan</option>
							<option>Feb</option>
							<option>Mar</option>
							<option>Apr</option>
							...
							<option value ="<?php echo mysql_result($result, 0, 25); ?>" selected="selected"><?php echo mysql_result($result, 0, 25); ?></option>
							<option>01</option>
							<option>02</option>
							<option>03</option>
							<option>04</option>
							...
							<option value ="<?php echo mysql_result($result, 0, 26); ?>" selected="selected"><?php echo mysql_result($result, 0, 26); ?></option>							<option>2012</option>
							<option>2013</option>
							<option>2014</option>
							<option>2015</option>
							<option>2016</option>
							...
							<option value ="<?php echo mysql_result($result, 0, 9); ?>" selected="selected"><?php echo mysql_result($result, 0, 9); ?></option>
							...
							<br />
							<br />
							Problem Type:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select name="Problem_type" style="width: 200px">
							<option value ="<?php echo mysql_result($result, 0, 13); ?>" selected="selected"><?php echo mysql_result($result, 0, 13); ?></option>
							<option>lab</option>
							...
							Location:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							Bldg&nbsp;<select name="Building2" onchange ='CheckBld(this.value);' style="width: 70px">
							<option value ="<?php echo mysql_result($result, 0, 10); ?>" selected="selected"><?php echo mysql_result($result, 0, 10); ?></option>
							<option>RVR</option>
							<option>SCL</option>
							<option>ARC</option>
							<option>Other</option>
							...
							value ="<?php echo mysql_result($result, 0, 11); ?>" /> 
							&nbsp;
							<br />
							<br />
							Computer Name:&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="Computer_name" style="width: 200px" type="text"
							 value ="<?php echo mysql_result($result, 0, 14); ?>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<br />
							<br />
							Where in Room:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 					<input name="Position_room" style="width: 200px" type="text" 
							 value ="<?php echo mysql_result($result, 0, 12); ?>" /><br />
							<br />							 
							Reporter Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="Fullname" style="width: 200px" type="text" 
							 value ="<?php echo mysql_result($result, 0, 15); ?>" /><br />
							<br />
							Reporter Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="Email_adr" style="width: 200px" type="text"
							 value ="<?php echo mysql_result($result, 0, 16); ?>" /><br />
							<br />
							Reporter Phone:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="Contact" style="width: 200px" type="text"
							 value ="<?php echo mysql_result($result, 0, 17); ?>" /><br />
							<br />
							Priority:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							<select name="Priority" style="width: 200px">
							<option value ="<?php echo mysql_result($result, 0, 4); ?>" selected="selected"><?php echo mysql_result($result, 0, 4); ?></option>
							<option>low</option>
							<option>med</option>
							<option>high</option>
							</select>
							<br />
							<br />
							Escalation:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="Escalation" style="width: 200px">
							<option value ="<?php echo mysql_result($result, 0, 5); ?>" selected="selected"><?php echo mysql_result($result, 0, 5); ?></option>
							...
							value ="<?php echo mysql_result($result, 0, 19); ?>" />
							<!--put name="Email" style="width: 200px" type="text"
							value ="<?php echo $_SESSION['email_adr']; ?>" />-->
							<br />
							<br />
							Resolution:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 							
							<textarea name="Prob_Resolution" style="width: 400px; height: 81px;"><?php echo mysql_result($result, 0, 18); ?></textarea>
							<br />
							<br />
							Date Entered:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="Date_Entered" style="width: 200px" type="text" readonly="readonly"
							value ="<?php echo mysql_result($result, 0, 6); ?>" /><br />
							<br />
							Date Completed:&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="Date_Complete" style="width: 200px" type="text"
							value ="<?php echo mysql_result($result, 0, 7); ?>" />
							<br />
							<br />
							Completed By:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="Completed_By" style="width: 200px" type="text"
							value ="<?php echo mysql_result($result, 0, 20); ?>" /><br />
							</span><br />		
							<br />
							<br />
