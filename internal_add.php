...
// Adds internal users only. Accessible by Admins only!
		...
		if (trim($_SESSION['user_group']) == "student" || trim($_SESSION['user_group']) == "faculty")
			...
			<div id="main_content" class="fancy_border bordered_sidebars grid_13 omega">
				<div class="wrapper"><strong><span class="auto-style1">Problem 
					...
					<div style="clear:both;"><br />
						<br />
						<span class="auto-style2">Manage Users - Add New User<br />
						</span><font color="red"><?php echo $_SESSION['emptyError']; echo "\n\n";?></font> <br />
						<br />
						<form action="add_internal.php" method="post" name="newUserForm">
							<span class="auto-style3"><br />
							First Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="fname" style="width: 200px" type="text" /><br />
							<br />
							...
							<input name="email_adr" style="width: 200px" type="text" /><br />
							<br />
							Contact #&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="contact" style="width: 200px" type="text" /><br />
							<br />
							Date Active&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="date_active" style="width: 200px" type="text" /><br />
							<br />
							Date Inactive&nbsp;&nbsp;&nbsp;&nbsp;
							<input name="date_inactive" style="width: 200px" type="text" /><br />
							<br />
							User Group&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							...
							/>&nbsp;&nbsp;<span><font color="red"> <?php echo $_SESSION['usernameError']; ?></font><br />
							<br />
							Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<br />
							<br />
							<input name="Submit1" type="submit" value="Create" /> </div>
		</div>
